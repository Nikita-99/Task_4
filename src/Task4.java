public class Task4 {
    public static void main(String[] args) {
        Zad1.bessie(10, 7, "hello my name is Bessie and this is my essay");
        System.out.println();
        System.out.println(Zad2.split("()()()"));
        System.out.println(Zad3.toCamelCase("is_modal_open"));
        System.out.println(Zad3.toSnakeCase("helloEdabit"));
        System.out.println(Zad4.overTime(9, 17, 30, 1.5));
        Zad5.BMI("55 kilos", "1.65 meters");
        System.out.println();
        System.out.println(Zad6.bugger(39));
        System.out.println(Zad7.toStarShorthand("abbccc"));
        System.out.println(Zad8.doesRhyme("Sam I am!", "Green eggs and ham."));
        System.out.println(Zad9.trouble(451999277, 411777299));
        System.out.println(Zad10.countUniqueBooks("AZYWABBCATTTA", 'A'));
    }
}
